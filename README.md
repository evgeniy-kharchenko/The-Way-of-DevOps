...
- DevOps ways of working - ветвь развития, посвящена совершенствованию компетенций и навыков связанных с 

Адаптация и функционирование организационных процессов для поддержки культуры и способов работы DevOps

Помимо технических автоматизированных возможностей; это требует других изменений в методах работы для достижения полной отдачи и формирования особой культуры

Это будет зависеть от вашей общей организационной структуры, но вам, вероятно, потребуется взглянуть на отделы, команды и роли, выходящие за рамки ваших основных команд DevOps. Навыки, перечисленные здесь, дают зацепку в этом обсуждении.